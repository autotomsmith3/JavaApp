...
//						================mediaObject==============
						...
						for (int m = 0; m < mediaObjsize; m++) {
							...
							for (int n = 0; n < mediaSize; n++) {
								String optionString = mediaOptionArr.getString(n); // SWP - this is how to get dynomic
																					// object
//								System.out.println("optionString=\n" + optionString);
								JSONObject mediasubObj = mediaObj.getJSONObject(optionString); // SWP - this is how to
																								// get dynomic object
