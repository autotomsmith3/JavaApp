...
public class compareBS_text_outPutAcodeName {
	...
	public static void PostText(String env, String client, String envClientTextURL, String headers[],
		...
		try {
			prop.load(compareBS_text_outPutAcodeName.class.getClassLoader()
...
//		String getMakeModelURL = envURL;// + VehicleSetCode + "/" + LngCode + "/" + CountryCode + "/" + year;
		...
		for (String Text_Body : TextBodys) {
			count++;
			String jsonTextFrGetMakeModelWS = com_libs.getNewSourceCodeJsonPostTextOutPutAcodeName(env, client, Text_Body, envURL, "",
